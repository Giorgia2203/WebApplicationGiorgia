...
namespace WebApplicationGiorgia.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(WebApplicationGiorgiaContext context,Book book)
        {
        ...
        public void UpdateBookCategories(WebApplicationGiorgiaContext context,string[] selectedCategories, Book bookToUpdate)
        {
